        ...
        <v-tooltip bottom>
          <template v-slot:activator="{on}">
            <v-btn
              ...
              v-on="on"
              @click.stop="
                !!analysisEditType || !!analysisIframeUrl
                  ? stopAnalysis()
                  : (analysisSpeedDialOpen = !analysisSpeedDialOpen)
              "
            >
          ...
          <span>{{
            !!analysisEditType || !!analysisIframeUrl || analysisSpeedDialOpen
              ? $t('general.close')
              : $t('tooltip.analyzePolygon')
          }}</span>
        </v-tooltip>
      </template>
