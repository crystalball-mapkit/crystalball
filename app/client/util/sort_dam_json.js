...
const allFeatures = [...aluminum.features, ...otherDams.features, ...bureau.features, ...armyCorps.features];

allFeatures.sort((a, b) => parseInt(a.properties.date, 10) - parseInt(b.properties.date, 10));
